...
public class NfcTagController {
	...
	// Aquí escrivim el tipus del tag ("5" o "4A")
...
//			firstTagSize.set("");
	...
	public void validateNdef() throws NoSuchAlgorithmException {
		// Aquí llegim el tag i fem la comprovació de la signatura digital.
		// Si tot queda comprovat correctament, procedirem a donar la informació del supply.
		if (recognizedNFCTag != null) {
			try {
				...
				// PART 1: Validació del proveïdor:
				...
				// PART 3: Display d'informació en cas que tot sigui correcte:
